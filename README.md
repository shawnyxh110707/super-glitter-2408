...
```
npm create cloudflare@latest -- --template=cloudflare/templates/super-glitter-2408
```

A live public deployment of this template is available at [https://super-glitter-2408.templates.workers.dev](https://super-glitter-2408.templates.workers.dev)
